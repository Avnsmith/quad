...
const KV_KEY = "badges:earlyQuadrant:frozen";
const FILE_URL = new URL("../../data/badges/earlyQuadrant.frozen.json", import.meta.url);
...
export async function isFrozenEarlyQuader(address) {
...
export async function getFrozenEarlyQuaderAddresses() {
  const set = await getFrozenSet();
  return Array.from(set);
}

export function invalidateFrozenEarlyQuaderCache() {
  cache = null;
}

export const EARLY_QUADER_FROZEN_KV_KEY = KV_KEY;
