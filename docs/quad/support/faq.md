...
The app is wired to a **fixed set of tokens** (for example USDC, EURC, QDRC on Arc testnet) and separate addresses for **swap pool**, **LP pools** and **privacy pools** per asset where configured. See [Networks and glossary](../introduction/networks-and-glossary.md).
